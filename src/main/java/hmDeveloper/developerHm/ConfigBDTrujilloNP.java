...
@EnableJpaRepositories(entityManagerFactoryRef = "trujilloNPEntityManagerFactory", transactionManagerRef = "trujilloNPTransactionManagerFactory", basePackages = {"hmDeveloper.developerHM.models.spTrujilloNP.repository"})
public class ConfigBDTrujilloNP {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(){
        ...
        em.setPackagesToScan("hmDeveloper.developerHM.models.spTrujilloNP.entity");
